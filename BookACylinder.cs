...
namespace EWALLET
{
    public partial class BookACylinder : Form
    {
        int bal=0;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Close();
                // add operation
                if (bal < Convert.ToInt32(textBox1.Text))
                {
                ...
                else
                {
                    ...
                    bal -= Convert.ToInt32(textBox1.Text);
                    ...
                    con.Close();
                    MessageBox.Show("Your Gas Has Book");
                }
            }
        }
